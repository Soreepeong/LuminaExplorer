...
public sealed class VirtualFileDataObject : System.Runtime.InteropServices.ComTypes.IDataObject, IAsyncOperation {
    ...
    /// </summary>
    private static readonly short FILECONTENTS = (short) (DataFormats.GetFormat(NativeMethods.CFSTR_FILECONTENTS).Id);
    ...
    private class DataObject {
        ...
        /// </summary>
        public Func<Tuple<IntPtr, int>> GetData { get; set; } = null!;
    }

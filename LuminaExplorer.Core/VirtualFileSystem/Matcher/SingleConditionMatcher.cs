...
public class SingleConditionMatcher : IMatcher {
    ...
    public Task<bool> Matches(IVirtualFileSystem tree, IVirtualFolder folder, Stopwatch stopwatch, TimeSpan timeout,
        ...
        _matchWhat switch {
            ...
            MatchWhat.Hash => _hashMatcher!.Matches(folder.PathHash, cancellationToken),
    ...
    public async Task<bool> Matches(IVirtualFileSystem tree, IVirtualFile file, Lazy<IVirtualFileLookup> lookup,
        ...
        return _matchWhat switch {
            ...
            MatchWhat.Hash => await _hashMatcher!.Matches(file.NameHash, cancellationToken)

...
partial class Explorer {
    ...
    private void InitializeComponent() {
        ...
        txtPath = new SimpleControlLibraries.ToolStripSpringComboBox();
        btnSearchAdvanced = new ToolStripButton();
        ...
        tspNavigation.Items.AddRange(new ToolStripItem[] { btnNavBack, btnNavForward, btnsHistory, btnNavUp, txtPath, btnSearchAdvanced, btnSearch, txtSearch });
        ...
        txtPath.Size = new Size(920, 25);
        txtPath.KeyDown += txtPath_KeyDown;
        txtPath.KeyUp += txtPath_KeyUp;
        // 
        // btnSearchAdvanced
        // 
        btnSearchAdvanced.Alignment = ToolStripItemAlignment.Right;
        btnSearchAdvanced.Image = (Image)resources.GetObject("btnSearchAdvanced.Image");
        btnSearchAdvanced.ImageTransparentColor = Color.Magenta;
        btnSearchAdvanced.Name = "btnSearchAdvanced";
        btnSearchAdvanced.Size = new Size(43, 22);
        btnSearchAdvanced.Text = "++";
        // 
        // btnSearch
        // 
    ...
    private SimpleControlLibraries.ToolStripSpringComboBox txtPath;
    private ToolStripTextBox txtSearch;
    private ToolStripButton btnSearch;
    private ToolStripDropDownButton btnsHistory;
    private ToolStripButton btnSearchAdvanced;
